...
function model_temperatures(
    ...
    t_LOCA1 = Float64(t_LOCA1)
    t_LOCA2 = Float64(t_LOCA2)
    t_LOCA3 = Float64(t_LOCA3)
    t_LOCA4 = Float64(t_LOCA4)
    t_ACS1 = Float64(t_ACS1)
    t_ACS2 = Float64(t_ACS2)
    t_ACS3 = Float64(t_ACS3)
    t_ACS4 = Float64(t_ACS4)
    tr_ACS1 = Float64(tr_ACS1)
    tr_ACS2 = Float64(tr_ACS2)
    tr_ACS3 = Float64(tr_ACS3)
    tr_ACS4 = Float64(tr_ACS4)
    t_EDG1 = Float64(t_EDG1)
    t_EDG2 = Float64(t_EDG2)
    tr_EDG1 = Float64(tr_EDG1)
    tr_EDG2 = Float64(tr_EDG2)
